from nnunet.training.network_training.nnUNetTrainerV2_DRO import nnUNetTrainerV2_DRO, CLIP_IMPORTANCE_WEIGHTS


class nnUNetTrainerV2_DRO_IS_Momentum(nnUNetTrainerV2_DRO):
