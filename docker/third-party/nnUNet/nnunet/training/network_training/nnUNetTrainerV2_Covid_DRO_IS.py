from nnunet.training.network_training.nnUNetTrainerV2_Covid_DRO import nnUNetTrainerV2_Covid_DRO, CLIP_IMPORTANCE_WEIGHTS


class nnUNetTrainerV2_Covid_DRO_IS(nnUNetTrainerV2_Covid_DRO):
