from nnunet.training.network_training.nnUNetTrainerV2_Covid_DRO10 import nnUNetTrainerV2_Covid_DRO10
from nnunet.training.network_training.nnUNetTrainerV2_Covid_DRO import CLIP_IMPORTANCE_WEIGHTS


class nnUNetTrainerV2_Covid_DRO10_IS(nnUNetTrainerV2_Covid_DRO10):
