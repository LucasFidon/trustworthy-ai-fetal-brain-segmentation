...
DATA_FOLDER = "/data/fetal_brain_srr_parcellation_Jun21_atlas_autocomplete_partially_sup"
...
def main():
    task_name = "Task225_FetalBrain3dTrust"  # 164 training cases
    ...
    # Training data
    train_csv = join(DATA_FOLDER, 'training_fold0.csv')
    ...
    valid_csv = join(DATA_FOLDER, 'validation_fold0.csv')
    ...
    # Testing data
    test_patient_names = []
    test_csv = join(DATA_FOLDER, 'inference_fold0.csv')
    ...
    json_dict['name'] = "FetalBrain3D_Trust"
