...
if __name__ == "__main__":
    ...
    downloaded_data_dir = os.path.join(DATA_FOLDER, "MICCAI_BraTS_2019_Data_Training")
    ...
    downloaded_data_dir = os.path.join(DATA_FOLDER, "MICCAI_BraTS_2019_Data_Validation")
