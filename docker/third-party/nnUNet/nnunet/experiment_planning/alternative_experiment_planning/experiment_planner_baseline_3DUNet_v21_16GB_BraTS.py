...
class ExperimentPlanner3D_v21_16GB_BraTS(ExperimentPlanner3D_v21):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_v21_16GB_BraTS, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_v2.1_16GB_BraTS"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansv2.1_16GB_BraTS_plans_3D.pkl")
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        # to be used
        ref = Generic_UNet.use_this_for_batch_size_computation_3D * 12 / 8
