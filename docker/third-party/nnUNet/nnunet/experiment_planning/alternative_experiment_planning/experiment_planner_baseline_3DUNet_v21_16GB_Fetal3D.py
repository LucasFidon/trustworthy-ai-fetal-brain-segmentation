...
class ExperimentPlanner3D_v21_16GB_Fetal3D(ExperimentPlanner3D_v21):
    """
    Same as ExperimentPlanner3D_v21, but designed to fill 16GB
    """
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_v21_16GB_Fetal3D, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_v2.1_16GB_Fetal3D"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansv2.1_16GB_Fetal3D_plans_3D.pkl")
