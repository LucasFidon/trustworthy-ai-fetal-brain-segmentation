...
class ExperimentPlanner3D_v21_16GB_Covid(ExperimentPlanner3D_v21):
    """
    Same as ExperimentPlanner3D_v21, but designed to fill 16GB
    """
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_v21_16GB_Covid, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_v2.1_16GB_Covid"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansv2.1_16GB_Covid_plans_3D.pkl")
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        # typical ExperimentPlanner3D_v21 configurations use 7.5GB, we have 16. Allow for more space
        # to be used
        ref = Generic_UNet.use_this_for_batch_size_computation_3D * 16 / 8
