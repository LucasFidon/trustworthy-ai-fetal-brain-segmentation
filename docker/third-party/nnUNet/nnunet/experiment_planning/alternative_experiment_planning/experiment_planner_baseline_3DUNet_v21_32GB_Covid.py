...
class ExperimentPlanner3D_v21_32GB_Covid(ExperimentPlanner3D_v21):
    """
    Same as ExperimentPlanner3D_v21, but designed to fill 16GB
    """
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_v21_32GB_Covid, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_v2.1_32GB_Covid"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansv2.1_32GB_Covid_plans_3D.pkl")
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        # to be used
        ref = Generic_UNet.use_this_for_batch_size_computation_3D * 12 / 8  # same as in _16GB
        ...
        batch_size = int(np.floor(max((2 * ref) / here, 1) * batch_size))  # x2 batch size
