...
def main():
    ...
    parser.add_argument('-e', '--save_npz_embedding', required=False, action='store_true')
    ...
    parser.add_argument("--force_separate_z", required=False, default="None", type=str,
                        help="force_separate_z resampling. Can be None, True or False, has no effect if mode=fastest. "
                             "Do not touch this.")
    parser.add_argument('--checkpoint', default='final', help='final or best')
    ...
    save_npz_embedding = args.save_npz_embedding
    ...
    if args.checkpoint == 'best':
        print('Use best checkpoint on validation')
        checkpoint_name = 'model_best'
    else:
        print('Use final checkpoint')
    ...
    predict_from_folder(model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
                        ...
                        step_size=step_size, force_separate_z=force_separate_z, interp_order=interp_order,
                        interp_order_z=interp_order_z,
                        checkpoint_name=checkpoint_name,  # new param: Lucas' stuff
                        save_npz_embedding=save_npz_embedding  # new param: Lucas' stuff
                        )
